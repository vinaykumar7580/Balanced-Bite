...
export function Addproductadmin() {
  ...
  return (
    <Box>
      <Heading as="h2" fontSize={"25px"} textAlign={"left"}>
        Add Products
      </Heading>
      <br />
      <Box
      ...
      >
        ...
        <Box>
          ...
          <Input
            ...
            border={erro ? "2px solid red" : ""}
            backgroundColor={"#c1d6f3"}
            placeholder="Enter time limit to prepare the product"
        ...
        <Box>
          ...
          <Input
            ...
            border={erro ? "2px solid red" : ""}
            backgroundColor={"#c1d6f3"}
            placeholder="Enter ingredients_image"
            onChange={(e) => setingimg(e.target.value)}
          />
        </Box>
      </Box>
        ...
        >
          <Box display={"flex"}>
            <Box w="20%" display={"flex"}>
              <Text textAlign={"left"}>
                <b>Add Instructions (Add atleast first 3 details)</b>
              </Text>
            </Box>
            <Box w="80%">
              <Input
                ...
                value={insone}
                border={erro ? "2px solid red" : ""}
                onChange={(e) => setinsone(e.target.value)}
                size="md"
                type="text"
                backgroundColor={"#c1d6f3"}
                placeholder="Enter instruction_details"
              ></Input>
              <Input
                name="instwo"
                value={instwo}
                border={erro ? "2px solid red" : ""}
                onChange={(e) => setinstwo(e.target.value)}
                size="md"
                mt="4%"
                type="text"
                backgroundColor={"#c1d6f3"}
              ...
              <Input
                ...
                value={insthree}
                border={erro ? "2px solid red" : ""}
                onChange={(e) => setinsthree(e.target.value)}
                size="md"
                mt="4%"
                type="text"
                backgroundColor={"#c1d6f3"}
              ...
              <Input
                name="insfour"
                value={insfour}
                onChange={(e) => setinsfour(e.target.value)}
                size="md"
                mt="4%"
                type="text"
                backgroundColor={"#c1d6f3"}
              ...
              <Input
                name="insfive"
                value={insfive}
                onChange={(e) => setinsfive(e.target.value)}
                size="md"
                mt="4%"
                type="text"
                backgroundColor={"#c1d6f3"}
              ...
              <Input
                name="inssix"
                value={inssix}
                onChange={(e) => setinssix(e.target.value)}
                size="md"
                mt="4%"
                type="text"
                backgroundColor={"#c1d6f3"}
          ...
          <Box display={"flex"}>
            <Box w="20%" display={"flex"}>
              <Text textAlign={"left"}>
                <b>Add Images (Add atleast first 3 images)</b>
              </Text>
            </Box>
            <Box w="80%">
              <Input
                ...
                type="text"
                backgroundColor={"#c1d6f3"}
                placeholder="Enter instruction_Images"
              ></Input>
              <Input
                name="imgtwo"
                value={imgtwo}
              ...
              <Input
                name="imgsix"
                value={imgsix}
                onChange={(e) => setimgsix(e.target.value)}
                size="md"
                mt="4%"
                type="text"
                backgroundColor={"#c1d6f3"}
        ...
        <Box>
            ...
            <Text>
              <b>
                ...
                <span style={{ color: "green" }}>
                  (Add ingredients details seperated by commas)
                </span>
              </b>
            </Text>
          </Box>
          <Box w="100%" textAlign={"right"}>
            <Textarea
              ...
              backgroundColor={"#c1d6f3"}
              placeholder="Enter ingredients_details"
            ></Textarea>
          </Box>
