...
import {
  ...
  ERROR,
  UPDATE_PRODUCT,
} from "../Redux/AdminReducer/actionType";
...
export function Updateproductadmin() {
  ...
  function handlesubmit() {
    if (name && title && about_dish && category && calories && price && time) {
      ...
      dispatch(updateproduct(data._id, obj))
        .then((res) => {
        ...
        >
          ...
          <Box>
            ...
            <Input
              ...
              onChange={(e) => setabout_dish(e.target.value)}
            />
          </Box>
          <Box>
          ...
          <Box textAlign={"center"} mt="2%" pl={"5px"}>
            ...
            <Modal isOpen={isOpen} onClose={onClose}>
              ...
              <ModalContent top={"20%"}>
                ...
                <ModalCloseButton />
                <ModalBody>
                  During the deletion process, we will take all necessary
                  precautions to ensure the item and its related data are
                  permanently and securely removed from our databases and
                  backups. Our aim is to minimize the risk of any residual
                  traces or unintended retention. You will not be able to Undo
                  this data !
                </ModalBody>
                <ModalFooter>
