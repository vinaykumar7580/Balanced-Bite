      ...
      dispatch(register(obj))
        ...
        .catch((err) => {
          ...
          if (
            ...
            "Invalid password. It should contain at least one number, one special character, and be at least 8 characters long."
          ) {
            setisErrorpass(true);
          } else if (
            err.response.data.error === "Email already exists, Please Login !!"
          ) {
            setisErrorpass(false);
            setisErroremail(false);
            setisErrorname(false);
            ...
            toast({
              ...
              description:
                "For further process, Please Login to your account again !!",
              status: "warning",
              duration: 4000,
              isClosable: true,
            });
  ...
  return (
    <Box>
      {isLoading ? (
        ...
        <Box>
          <Navbar />
          <Box height={"300px"} backgroundColor={"#0f346c"}></Box>
          <Box>
            <Box
              data-aos="fade-left"
              position="relative"
            ...
            >
              ...
              >
                ...
                >
                  <img
                    src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=23&pause=1000&color=212121&repeat=false&width=445&lines=Register+to+Balanced+Bite."
                    alt="Typing SVG"
                  />
                </a>
              </Box>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              {!isErroremail ? (
                                <FormHelperText>
                                  Enter the email you'd like to receive payment
                                  details.
                                </FormHelperText>
                              ) : (
                                <FormErrorMessage>
                            ...
                            >
                              ...
                              {!isErrorpass ? (
                                <FormHelperText>
                                  ...
                                  one special character, and of atleast 8
                                  characters long.
                                </FormHelperText>
                              ) : (
                                <FormErrorMessage>
