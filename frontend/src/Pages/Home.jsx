...
function Home() {
  let card = [
    ...
    {
      image:
        "https://media.blueapron.com/assets/registration/homepage/heat-and-eat.webp?width=300&amp;height=300&amp;quality=90",
      head: "HEAT & EAT",
      ...
      <Box style={{ fontFamily: "Chronicle Deck", position: "relative" }}>
        <Box style={{ position: "sticky", top: 0, zIndex: 1, opacity: ".9" }}>
          ...
          >
            <Image
              src={cap}
              width={{ base: "40px", md: "90px", lg: "140px", xl: "170px" }}
              alt=""
            />
            <Heading
              as="h3"
        ...
        >
          <Box position="static" style={{ width: "90%", margin: "35px 0px" }}>
            <Box>
              <Center h="12%" color={"#1A237E"}>
                <Heading fontFamily="Chronicle Deck">
                  203+ million meals shipped
                </Heading>
              </Center>
              ...
              >
                <GridItem m={"auto"}>
                  ...
                  >
                    Our chefs bring high standards to crafting your meals.
                  </Text>
                </GridItem>
                <GridItem m={"auto"}>
              ...
              <Box mt="8%">
                <Heading color={"#1A237E"} fontFamily="Chronicle Deck">
                  CHOOSE FROM
                </Heading>
                <Heading
                  color={"#00a0df"}
          ...
          <Box position="static" style={{ width: "100%", height: "520px" }}>
            ...
            <Box
              ...
              position={"relative"}
              height={"65%"}
              width={{ base: "90%", sm: "79%", md: "45%" }}
              top={"-80%"}
              left={{ base: "5%", sm: "12%", md: "28%" }}
              backgroundColor={"white"}
              style={{
                display: "flex",
                alignItems: "center",
          ...
          >
            <Box
              ...
              filter="grayscale(35%)"
              backgroundImage='url("https://media.blueapron.com/assets/registration/homepage/green-field.png?height=400&quality=90")'
            >
              <Heading
                as="h2"
                size="xl"
          ...
          >
            ...
            <Box
              ...
              position={"relative"}
              height={"60%"}
              width={{ base: "90%", sm: "70%", md: "45%" }}
              top={"-80%"}
              left={{ base: "7%", sm: "15%", md: "30%" }}
              style={{
                padding: "0ps 15px",
                display: "flex",
                alignItems: "center",
            ...
            >
              ...
              <Text fontFamily="Chronicle Deck">
