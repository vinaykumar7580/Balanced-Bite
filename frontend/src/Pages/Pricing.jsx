...
function Pricing() {
  ...
  const handleDelete = () => {
    fetch(`${baseUrl}/cart/deleteallcart`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        Authorization: `${localStorage.getItem("token")}`,
    ...
    <Box backgroundColor={"#f8f9fa"}>
      ...
      >
        ...
        <Text
          ...
          marginTop={"5px"}
        >
          Get excited—your choice of 70+ weekly meals is just a few steps away!
        </Text>
        <br />
        <br />
        {cartProduct && (
        ...
        >
          <Box borderRight={["none", "none", "none", "1px solid #6A6D75"]}>
            <Heading fontSize={"2xl"} fontFamily={"heading"} color={"#303236"}>
            ...
            <Box marginTop={["10px", "10px", "10px", "20px"]}>
              <Button
                ...
                variant={"solid"}
                border={
                  chef == true ? "2px solid #002C9B" : "1px solid #6A6D75"
                }
                paddingBottom={"40px"}
              ...
              <Button
                ...
                variant={"solid"}
                border={
                  wellness == true ? "2px solid #002C9B" : "1px solid #6A6D75"
                }
                paddingBottom={"40px"}
                _hover={{ border: "2px solid #002C9B" }}
              ...
              <Button
                ...
                variant={"solid"}
                border={
                  family == true ? "2px solid #002C9B" : "1px solid #6A6D75"
                }
                paddingBottom={"40px"}
                _hover={{ border: "2px solid #002C9B" }}
              ...
              <Button
                ...
                variant={"solid"}
                border={
                  fast == true ? "2px solid #002C9B" : "1px solid #6A6D75"
                }
                paddingBottom={"40px"}
                _hover={{ border: "2px solid #002C9B" }}
              ...
              <Button
                ...
                variant={"solid"}
                border={
                  veggies == true ? "2px solid #002C9B" : "1px solid #6A6D75"
                }
                paddingBottom={"40px"}
                _hover={{ border: "2px solid #002C9B" }}
              ...
              <Text
                ...
                margin={"auto"}
              >
                Choose as many preferences as you like. They'll help us make
          ...
          <Box>
            ...
            >
              <Flex justifyContent={"space-between"}>
                <Text color={"#303236"} fontSize={"xl"} fontWeight={"bold"}>
                  Number of servings
                </Text>
                <Box>
                  <Button
              ...
              <Box>
                ...
                <Flex justifyContent={"space-between"} alignItems={"center"}>
                  ...
                  >
                    ${" "}
                    {cartProduct
                      ? (week + serving + cartProduct?.price).toFixed(2)
                ...
                <br />
                <br />
                <Box width={["90%", "80%", "75%", "70%"]} margin={"auto"}>
                  <Text
                    fontSize={"lg"}
                    fontFamily={"heading"}
                    color={"#6A6D75"}
                  >
                    You can update your preferences and skip, pause, or cancel
                    at any time.
                  </Text>
                </Box>
              </Box>
