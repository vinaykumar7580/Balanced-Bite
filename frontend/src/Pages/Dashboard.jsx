    ...
    <Box>
      {store.isLoading ? (
        ...
        <Box minH="100vh" bg={"gray.100"}>
          ...
          <Box
            paddingLeft={{ base: "5%", sm: "5%", md: "33%", lg: "23%" }}
            paddingRight={"5%"}
          >
            {place === "productsdata" ? (
              <Box>
    ...
    >
      <Flex h="20" alignItems="center" mx="8" justifyContent="space-between">
        <Reactlink to="/">
          <Image
            src={logo}
            width={{ base: "200px", sm: "200px", md: "auto", lg: "auto" }}
            ml={"-15%"}
            alt="Logo"
          />
        </Reactlink>
            ...
            >
              <HStack>
                ...
                <VStack
                  ...
                  ml="2"
                >
                  <Text fontSize="sm" color="black" data-aos="fade-left">
