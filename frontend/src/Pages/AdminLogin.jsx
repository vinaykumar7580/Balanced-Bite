    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent
          ...
          color={"white"}
        >
          <ModalHeader margin={"auto"} fontFamily="Chronicle Deck">
            <span style={{ fontSize: "25px" }}>V</span>erify your Admin Account
          </ModalHeader>
          <ModalCloseButton />
              ...
              <FormControl id="password" isInvalid={isErrorpass} isRequired>
                ...
                {!isErrorpass ? (
                  <FormHelperText color={"white"}>
                    ...
                    character, and of atleast 8 characters long.
                  </FormHelperText>
                ) : (
                  <FormErrorMessage color={"white"}>
                    Password should contain atleast one number, one special
