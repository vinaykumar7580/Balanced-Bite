  ...
  return (
    <Box>
      ...
      <Box textAlign="center" my={8}>
        ...
        <Flex mt={8} flexWrap={["wrap", "nowrap"]} gap={8}>
          ...
          <Box flexBasis={["100%", "50%"]}>
            ...
            <Text>
              Select the wines you love. No commitment. Skipping or canceling is
              easy.
            </Text>
          </Box>
          <Box flexBasis={["100%", "50%"]}>
            ...
            <Text>
              Enjoy pairing-sized wines (500ml), perfect for two to share, or
              upgrade to standard-sized bottles (750ml).
            </Text>
          </Box>
        </Flex>
      </Box>
      <Box position="relative">
        ...
        >
          ...
          >
            ...
            <Text mt={[2, 2, 2, 4]}>
              We'll include tasting notes, pairing tips, plus stories behind the
              wines.
            </Text>
          </Box>
          <Text
      ...
      <Box textAlign="center" my={[2, 2, 2, 8]} maxW="800px" mx="auto">
        ...
        <Text>
          By cutting out the middleman, we’re able to offer you high-quality
      ...
      <Box position="relative">
        ...
        >
          ...
          <Text>
            Don’t know your Pinot Noir from your Pinotage? Our wines come with
            tasting notes, flavor profiles, and the story behind the bottle to
            give you the confidence to select the right wine for any occasion –
            and inspire a lifelong love of wine.
          </Text>
        </Box>
      </Box>
      <Box>
        ...
        <Flex justify="center" py={8}>
          <Box>
            ...
            <Text>
              Complement the richness of this hearty beef & gnocchi dish with a
              warming, spicy grenache.
            </Text>
          </Box>
          <Box mx={8}>
        ...
        <Flex justify="center" py={8}>
          <Box>
            ...
            <Text>
              Complement the peppery flavors of the chorizo with the notes of
              baking spices in this wine.
            </Text>
          </Box>
          <Box mx={8}>
            <Image
            ...
            <Text>
              Notes of stone fruit in this grenache bring out the cherry flavors
              in this sauce.
            </Text>
          </Box>
        </Flex>
