    ...
    <Box paddingTop={["65px", "65px", "65px"]} fontFamily="Chronicle Deck">
      ...
      <Box p={8}>
        <Flex
          ...
          align="center"
        >
          <Box width={["100%", "100%", "50%"]} mb={[8, 8, 0]} pr={[0, 0, 8]}>
            <Box mt={[9, 9, 10, "150px"]}>
              <Button
          ...
          <Box width={["100%", "100%", "50%"]} pl={[0, 0, 8]}>
            ...
            <Box>
              <ul>
                <li>
                  Recipients can use a Meal E-Gift Card towards any subscription
                  meal plan or Market items
                </li>
                <li>
                  E-Gift Cards are subject to our Gift Card Terms and are not
                  redeemable towards our Wine Program
                </li>
                <li>Blue Apron Gift Cards never expire and carry no fees</li>
              </ul>
            </Box>
          </Box>
        </Flex>
